...
L.BattlePrint = _G.DUNGEON_FLOOR_TOLBARADWARLOCKSCENARIO0 .. " (" .. L.WarMode .. ": %s, %s controlled)"
L.BattleRaidWarning = "The Battle for " .. L.TolBarad .. " (" .. L.WarMode .. " %s, %s controlled)"
